...
//                        handler_longClick.postDelayed(runnable_longClick, 600);
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        //reset position if user drags the floating view 이 부분 수정함
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.open_activity_button:
                ...
                Intent intent = new Intent(FloatingWidgetService.this, PantsActivity.class);
                //기존 activity가 있으면 돌아가고, 없으면 새로운 task를 생성하는 flag
